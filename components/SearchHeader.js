        ...
        <View>
            ...
            >
                ...
                <Pressable
                    ...
                    onPress={() => { props.setTagValue('All'), props.setIsLoading(true), props.setSearchValue('') }}
                >
                    <Text
                    ...
                    categories.map((category) => {
                        return (
                            <Pressable
                                ...
                                onPress={() => { props.setTagValue(category), props.setIsLoading(true), props.setSearchValue('') }}
                            >
                                <Text
